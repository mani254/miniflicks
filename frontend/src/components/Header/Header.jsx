	...
	return (
		<header className="bg-white/60 backdrop-blur-md border-b border-white/10 shadow-md sticky top-0 z-50">
			<div className="flex items-center max-w-[1400px] px-2 py-1 m-auto justify-between relative">
				...
				<nav className={`fixed flex flex-col gap-6 top-0 ${isMobileNav ? "left-0" : "-left-[100%]"} bg-bright  w-full max-w-[280px] h-screen py-[10px] px-2 transition-all ease-in-out duration-300`}>
					<div className="flex items-center gap-2 ">
						<div className="logo bg-dark w-11 h-11 rounded-full flex items-center justify-center p-1">
							<img src={mfLogo} alt="miniflics logo" className="w-12"></img>
						</div>
					...
					<div className="flex flex-col gap-1">
						<NavLink to="/" className="hover:text-zinc-600 py-2 px-3 hover:bg-gray-200 rounded-lg">
							Home
						</NavLink>
						<NavLink to="/about" className="hover:text-zinc-600 py-2 px-3 hover:bg-gray-200 rounded-lg">
							About
						</NavLink>
						<NavLink to="/services" className="hover:text-zinc-600 py-2 px-3 hover:bg-gray-200 rounded-lg">
							Gallery
						</NavLink>
						<NavLink to="/services" className="hover:text-zinc-600 py-2 px-3 hover:bg-gray-200 rounded-lg">
							Testimonials
						</NavLink>
						<NavLink to="/contact" className="hover:text-zinc-600 py-2 px-3 hover:bg-gray-200 rounded-lg">
							Contact
						</NavLink>
					</div>
