      ...
      <div className="flex flex-col items-center justify-center space-y-2 text-center p-6 h-screen -mt-[60px]">
        <div className="w-[60px] h-[60px] rounded-full flex items-center justify-center relative mb-2">
          {showTick && (
            ...
            >
              ...
              <path
                className="tick-mark"
                d="M28 52.5C29.0884 53.9803 36.2254 62.2114 40.7238 67.364C41.4939 68.2461 42.8517 68.2769 43.6648 67.4343L74 36"
                stroke="white"
                strokeWidth="8"
                strokeLinecap="round"
        ...
        <div className="booking-success-message">
          ...
          <p className="mt-2 text-sm">
            Please check your email for the booking details, including your
            itinerary. If you don&apos;t see it, kindly check your spam or junk
            folder.
          </p>
        ...
        <div className=" mt-6 space-y-4">
          <p className="text-gray-600">
            ...
            <a
              href="mailto:miniflicksprivatetheatres@gmail.com"
