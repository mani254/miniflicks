			...
			{screens.length > 0 && (
				<div className="flex w-full justify-center gap-6 flex-wrap">
					{screens.map((screen, index) => (
						<div key={index} className="location-card card-1 w-full  md:max-w-[310px] p-3 bg-bright rounded-xl shadow-md cursor-pointer">
							<div className="swiper-2 w-full m-auto relative">
								<Swiper
									...
									autoplay={{ delay: 3000 + index * 300, disableOnInteraction: false }}
							...
							<h3 className="text-center border-b border-gray-300 pb-1 mt-1">{screen.name}</h3>
							<div className="flex justify-between items-start mt-4">
								...
								<div className="flex gap-x-2 items-center flex-wrap">
									...
									{screen.minPeople != screen.capacity ? (
										...
										<p className="whitespace-nowrap">{screen.capacity} people</p>
									)}
								</div>
							</div>
							<div className="book-now-btn mt-4" onClick={() => hanldeScreenClick(screen._id)}>
								<button className="btn-3 text-center w-full">
